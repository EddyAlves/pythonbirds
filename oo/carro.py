...
'''
Você deve criar uma classe carro que vai possuir dois atributos compostos por outroas duas classes:
...
2) Método acelerar, que deverá incremetar a velocidade em uma unidade
